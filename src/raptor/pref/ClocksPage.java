...
public class ClocksPage extends FieldEditorPreferencePage {
	...
	protected void createFieldEditors() {
		...
		IntegerFieldEditor r1 = new IntegerFieldEditor("seconds","Show Seconds After (Number of Minutes): ",getFieldEditorParent());
		addField(r1);
		
		String[][] showMS = {{"At 10 Seconds","10"},{"At 1 Minute","60"},{"Always","9999999999"}};
		RadioGroupFieldEditor r2 = new RadioGroupFieldEditor("milliseconds","Show Milliseconds:",3,showMS,getFieldEditorParent());
		addField(r2);
